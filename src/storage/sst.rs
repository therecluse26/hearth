...
mod tests {
    ...
    /// Crash during memtable flush — requires madsim infrastructure.
    #[test]
    #[ignore = "requires madsim simulation infrastructure"]
    fn simulation_crash_during_memtable_flush() {
        // TODO: Implement with madsim once simulation infra is available.
        // Should verify that a crash mid-flush leaves either:
        //   - No SST file (atomic write via rename)
        //   - A corrupt SST that is detected and discarded on recovery
    }

    /// Crash during compaction — requires madsim infrastructure.
    #[test]
    #[ignore = "requires madsim simulation infrastructure"]
    fn simulation_crash_during_compaction() {
        // TODO: Implement with madsim once simulation infra is available.
        // Should verify that source SSTs are not removed until the output
        // SST is fully written and validated.
    }

    /// Power-loss simulation — requires madsim infrastructure.
    #[test]
    #[ignore = "requires madsim simulation infrastructure"]
    fn simulation_power_loss() {
        // TODO: Implement with madsim once simulation infra is available.
        // Should verify end-to-end durability: WAL replay + SST recovery
        // produces correct state after simulated power loss at any point.
    }
}
