...
mod tests {
    ...
    fn simulation_tier_transitions_concurrent() {
        // TODO: Verify tier transitions preserve all data under concurrent load.
    }

    #[test]
    #[ignore = "requires madsim simulation infrastructure"]
    fn simulation_crash_during_promotion() {
        // TODO: Hot tier is in-memory — crash means empty tier.
        // Verify recovery from WAL+SST re-populates correctly.
    }
